    ...
    return(
        <div className = "container">
          <div className = "left-container">
            <div className = "words">
              <h1 className = "aggie">AGGIE</h1>
              <h1 className = "ville">VILLE</h1>   
            </div>
            <hr></hr>
            <div className = 'description-container'>
              <span className = "description">The first <em>centralized platform</em> for apartment search in the town of Davis. Streamline your housing hunt with AggieVille.</span>           
            </div>
            <div className = 'buttons'>
              <a href='./start-your-search'><button className='button-one' >Start Your Search</button></a>
              <a href='./compare'><button className='button-two'>Compare Options</button></a>
            </div>
          </div>
          <div className = "right-container">
            <img src="./background-final.png" className="background"/>
            <img className="image-one" src="./apartment1.jpeg"></img>
            <img className="image-two" src="./apartment2.jpeg"></img>
            <img className="image-three" src="./apartment3.webp"></img>
          </div>
        </div>
